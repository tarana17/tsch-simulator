...
function read_schedule(node) {
    ...
    try {
        ...
        // const schedule_file = "matlab-simulation/schedule_2/schedule.json";
        // const schedule_file = "examples/exampleTegveer/schedule.json";
        // const schedule_file = "matlab-simulation/simple-Exmp/schedule.json";
        const schedule_file = "matlab-simulation/scenario_1/schedule.json";
