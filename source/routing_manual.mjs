...
export class NewRouting
{
    ...
    start() {
        ...
        try {
            ...
            // const route_file = "matlab-simulation/schedule_2/routes.json";
            // const route_file = "matlab-simulation/simple-Exmp/routes.json";
            const route_file = "matlab-simulation/scenario_1/routes.json";
